...
import { getClosure, getAllClosures, saveClosure, validateClosure, unvalidateClosure, getClosureKPIs } from '../controllers/closureController';
...
router.get('/all', getAllClosures as any);
